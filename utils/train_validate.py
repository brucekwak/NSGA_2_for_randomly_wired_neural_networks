...
def test(test_loader, model, criterion, epoch, log_file_name):
    ...
    with torch.no_grad():
        ...
        print('##### Test_time {test_time:.3f} Prec@1 {top1.avg:.3f} Prec@5 {top5.avg:.3f} #####'
              .format(test_time=test_time, top1=top1, top5=top5))

        if log_file_name != None:
            logging.info('##### Test_time {test_time:.3f} Prec@1 {top1.avg:.3f} Prec@5 {top5.avg:.3f} #####'
              .format(test_time=test_time, top1=top1, top5=top5))
